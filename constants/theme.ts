...
export const Colors = {
  light: {
    ...
    danger: "#E74C3C",
    dangerSoft: "#FEF2F2",
    imagePlaceholder: "#DDE4FF",
    overlay: "rgba(15,23,42,0.18)",
    overlayStrong: "rgba(17,24,39,0.42)",
  ...
  dark: {
    ...
    danger: "#F87171",
    dangerSoft: "#3A1717",
    imagePlaceholder: "#303B47",
    overlay: "rgba(0,0,0,0.24)",
    overlayStrong: "rgba(0,0,0,0.54)",
    onPrimaryMuted: "rgba(0,0,0,0.72)",
    onPrimarySubtle: "rgba(0,0,0,0.82)",
    onPrimarySurface: "rgba(0,0,0,0.14)",
    shadow: "#000000",
    tint: tintColorDark,
    icon: "#9BA1A6",
